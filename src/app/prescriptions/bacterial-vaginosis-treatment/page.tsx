...
export default function BacterialVaginosisTreatmentPage() {
  ...
  const steps: {
  ...
  }[] = [
    {
      title: "Suitability",
      intro:
        "If you are pregnant you are unsuitable for this treatment. If this is the first time you have had Bacterial Vaginosis then we recommend you visit your local GP.",
      questions: [
        {
          id: "s1_q1",
          text: "Have you had Bacterial vaginosis in the past?",
          description: "This treatment is only suitable for patients who have had Bacterial Vaginosis in the past.",
          options: ["Yes I have", "No I haven't"],
        },
        {
          id: "s1_q2_request",
          text: "What type of treatment are you requesting?",
          description: "Oral treatment is in the form of pills and topical is in the form of ointment",
          options: ["Oral", "Topical"],
        },
        {
          id: "s1_q3",
    ...
    },
    {
      ...
      intro: "Please complete these safety checks before continuing.",
      questions: [
        { id: "s2_q1", text: "Are you currently breastfeeding?", options: ["Yes", "No"] },
        { id: "s2_q2", text: "Have you had 4 or more BV episodes in the last year?", options: ["Yes", "No"] },
        { id: "s2_q3", text: "Do you have severe lower abdominal pain or fever?", options: ["Yes", "No"] },
      ],
    },
    {
      title: "Symptoms",
      intro: "These questions help distinguish BV from other causes.",
      questions: [
        { id: "s3_q1", text: "Do you have a thin grey/white discharge with a fishy odour?", options: ["Yes", "No"] },
        { id: "s3_q2", text: "Do you have significant vulval itching and thick white discharge?", options: ["Yes", "No"] },
      ],
    },
    {
      title: "Other conditions",
      intro: "Please answer based on your current symptoms.",
      questions: [
        { id: "s4_q1", text: "Do you think you may have a sexually transmitted infection?", options: ["Yes", "No"] },
        { id: "s4_q2", text: "Do you have abnormal vaginal bleeding?", options: ["Yes", "No"] },
      ],
    },
    {
      title: "Allergies & medicines",
      intro: "Tell us about allergies and current medicines.",
      questions: [
        { id: "s5_q1", text: "Have you had an allergy to metronidazole or clindamycin before?", options: ["Yes", "No", "Not sure"] },
        { id: "s5_q2", text: "Are you taking regular prescription medicines?", options: ["Yes", "No"] },
      ],
    },
    {
      title: "Treatment guidance",
      intro: "Confirm important treatment guidance.",
      questions: [
        { id: "s6_q1", text: "I understand alcohol should be avoided with some oral BV antibiotics.", options: ["I confirm"] },
        { id: "s6_q2", text: "I understand treatment may be unsuitable and require GP review.", options: ["I confirm"] },
      ],
    },
    {
      title: "Consent",
      intro: "Please confirm your declarations.",
      questions: [
        { id: "s7_q1", text: "I consent to review by an Irish-registered doctor.", options: ["I confirm"] },
        { id: "s7_q2", text: "I confirm my answers are truthful and complete.", options: ["I confirm"] },
      ],
    },
    {
      title: "Review & submit",
  ...
  const currentStepQuestions =
    currentStep === 1
      ? (() => {
          const [pastBvQuestion, ...rest] = currentStepData.questions;
          if (answers["s1_q1"] === "Yes I have") {
            return [
              pastBvQuestion,
              {
                id: "s1_q2",
                text: "What treatment did you have?",
                options: ["Oral", "Topical/Vaginal"],
              },
              ...rest,
            ];
          }
          return [pastBvQuestion, ...rest];
        })()
  ...
  const stepOneUnsuitable = answers["s1_q1"] === "No I haven't" || answers["s1_q3"] === "Yes";
  ...
  const startQuestionnaire = () => {
    ...
    setSubmitted(false);
    setTimeout(() => {
      document.getElementById("bv-questionnaire")?.scrollIntoView({ behavior: "smooth", block: "start" });
    }, 0);
  };

  const submitPrescriptionRequest = () => {
    beginPrescriptionCheckout({
      slug: 'bacterial-vaginosis-treatment',
      serviceName: 'Bacterial Vaginosis Treatment',
      payload: {
      answers,
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-black text-dark-slate dark:text-white leading-tight">
                Bacterial Vaginosis <span className="text-primary">Treatment</span>
              </h1>
            ...
            <div className="rounded-[36px] overflow-hidden bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Bacterial vaginosis (BV) is a vaginal infection caused by an imbalance of the normal bacteria in the
                vagina. Over-the-counter BV treatments are often very effective, but sometimes prescription treatments
                are needed. At Webdoctor.ie, we can issue prescriptions for medication, subject to clinical suitability.
                Antibiotic tablets are prescribed as a first-line treatment twice daily for 1 week, but if you would
                prefer a local treatment (vaginal cream) please send us a message with your application to let us know.
              </p>
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                <li>Oral Antibiotics (Tablets)</li>
                <li>Vaginal Antibiotic Cream</li>
              </ul>
        ...
        {showQuestionnaire && (
          <section id="bv-questionnaire" className="pb-16">
            <div className="max-w-4xl mx-auto px-6">
              <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 md:p-8">
                <div className="h-2 rounded-full bg-slate-200 overflow-hidden">
                  <div className="h-full bg-primary" style={{ width: `${(currentStep / 8) * 100}%` }} />
                </div>
                <p className="mt-3 text-sm font-bold text-slate-600">Step {currentStep} / 8</p>
                ...
                <div className="mt-8 space-y-7">
                          ...
                          {question.options.map((option) => (
                            <button
                              ...
                              onClick={() => {
                                ...
                                if (currentStep === 1 && (question.id === "s1_q1" || question.id === "s1_q3")) {
                                  setUnderstandUnsuitable(false);
                                }
                              }}
                  ...
                  {currentStep === 1 && stepOneUnsuitable && (
                    <div className="rounded-2xl border border-amber-300 bg-amber-50 p-5">
                      ...
                      {answers["s1_q1"] === "No I haven't" && (
                        <p className="mt-2 text-sm text-amber-900">
                          This service is only suitable for patients who have had Bacterial Vaginosis in the past.
                        </p>
                      )}
                      {answers["s1_q3"] === "Yes" && (
                        <p className="mt-2 text-sm text-amber-900">
                          This treatment is not suitable during pregnancy. Please arrange a GP consultation.
                        </p>
                      )}
                      <button
                        type="button"
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3">
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-300">
                      The service is suitable if you have a previously confirmed diagnosis of bacterial vaginosis by a
                      doctor and you are not having recurrent episodes (more than 4 in the past year).
                    </p>
                  </li>
                </ul>
              </div>
              <div className="p-8 rounded-3xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3">
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-300">
                      Bacterial vaginosis can lead to complications if you are pregnant or trying to conceive and a
                      face-to-face medical assessment is essential at these times. If you are breastfeeding, please
                      arrange a GP Video Consultation or speak with your local doctor as a more detailed clinical
                      assessment is required than can be arranged via this service.
                    </p>
                  </li>
                  <li className="flex gap-3">
                    <XCircle className="w-5 h-5 text-red-500 mt-0.5 shrink-0" />
                    <p className="text-sm text-slate-700 dark:text-slate-300">
                      If you are having recurrent bacterial vaginosis (4 or more episodes in one year), you should
                      arrange an in-person doctor review for assessment. This service is not suitable for the ongoing
                  ...
                  <li className="flex gap-3">
                    <XCircle className="w-5 h-5 text-red-500 mt-0.5 shrink-0" />
                    <p className="text-sm text-slate-700 dark:text-slate-300">
                      Bacterial vaginosis can sometimes be confused with vaginal candida/ thrush infection. Vaginal
                      candida/ thrush is a fungal infection and typically causes a thick, white discharge with itching/
                      irritation around the vagina/ vulva. The treatment for thrush is very different to bacterial
                      vaginosis treatment. It can sometimes be difficult to know if you have bacterial vaginosis or
                      genital candida/ thrush. If you are unsure, we suggest arranging an online GP video consultation
                      with one of our doctors or an appointment with your local GP.
                    </p>
                  </li>
                </ul>
              </div>
